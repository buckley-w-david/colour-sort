...
# Retrieved from the wayback machine: https://web.archive.org/web/20180307004246/http://www.tiac.net/~sw/2008/10/Hilbert/hilbert.py

# FIXME: This needs way more work, it was obviously written for python2
...
def gray_encode(bn):
    assert bn >= 0
    assert type(bn) is int  # in [ int, long ]
